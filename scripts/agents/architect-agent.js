...
export class ArchitectAgent extends GenerativeAgent {
  ...
  get systemPrompt() {
    ...
    - Use only core SRD spell names exactly as they appear in the standard dnd5e compendium (e.g., "Fireball", "Lightning Bolt", "Animate Dead", "Shocking Grasp", "Shield", "Mage Armor"). Do NOT use spells from supplemental books such as "Booming Blade" (SCAG), "Absorb Elements" (XGtE), "Toll the Dead" (XGtE), or any other non-SRD spell — these will not be found.
